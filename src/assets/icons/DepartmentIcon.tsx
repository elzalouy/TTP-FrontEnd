...
const DepartmentIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g id="Departments" transform="translate(-84 -347)" className="dep">
      <rect
        id="Rectangle_8"
      ...
      <g
        ...
        transform="translate(87 349)"
      >
        <g id="Document" className="dep"  transform="translate(0)">
          <path
            id="Document-2"
            className="dep"
            data-name="Document"

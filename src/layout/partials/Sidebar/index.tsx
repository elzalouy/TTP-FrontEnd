        ...
        <div className={`side-bar ${toggle && 'toogle-width'}`}>
            <div className="logo-name-wrapper">
                <div className="logo-name">
                    ...
                    <span onClick={() => setToggle(!toggle)} className={toggle ? "active-burger-toggel-width" : ""}><BurgerIcon /></span>
                </div>
            ...
            <div style={{ width: "100%", alignItems: "center", margin: "0px 35px 35px 35px", paddingLeft: "35px" }}>
            ...
            <div className="user-information">
                <div className="user-information-sub">
                    ...
                    {!toggle && <div>
                        <span>Ahemd Ali</span><br />
                        <Typography color='primary.light' variant="subtitle1" component="span">
                            Admin</Typography>
                    </div>
                    }
                </div>
                {!toggle &&
                    <img style={{ width: "17px", cursor: "pointer" }} src={IMAGES.logouticon} />
                }
            </div>
        </div>
    );

...
describe("Create Task", () => {
  it("It should create a project and open it", () => {
    ...
    cy.get('[data-test-id="create-project-client-select"]')
      .click()
      .wait(1000)
    ...
    cy.get('[data-test-id="create-project-pm-select"]')
      .click()
      .wait(1000)
      .get('[data-test-id="create-project-pm-select-option"]')
      .first()
      .click({ force: true });
  ...
  it("It should open a project and create a task", () => {
    ...
    cy.get('[data-test-id="create-task-dep-select"]')
      .click()
      .wait(1000)
      .get('[data-test-id="create-task-dep-select-option"]')
      .first()
      .click({ force: true });
    cy.get('[data-test-id="create-task-cat-select"]')
      .click()
      .wait(1000)
      .get('[data-test-id="create-task-cat-select-option"]')
      .first()
      .click({ force: true });
...
describe("Delete Task", () => {
  it("It should delete the task", () => {
    ...
    cy.get('[data-test-id="task-card-container"]').should(
      "not.have.text",
      "Automated Task Updated"
    );
  });
...
describe("Edit Task with Attachment", () => {
  it("It should edit the name of the task", () => {
    ...
    cy.wait(3000)
      .get(".task-card")
      .contains("Automated Task With Attachment Updated")
      .should("be.visible");
  });
  ...
  it("It should delete the task", () => {
    ...
    cy.get('[data-test-id="task-card-container"]').should(
      "not.have.text",
      "Automated Task With Attachment"
    );
  });
